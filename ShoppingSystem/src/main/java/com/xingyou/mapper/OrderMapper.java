...
public interface OrderMapper {
     ...
     * 更新订单折扣信息
     * 
     * 设置订单的折扣率和原价，并自动重新计算实际支付金额。
     *
     * @param id 订单ID
     * @param originalAmount 订单原价
     * @param discount 折扣率（0-1之间，如0.8表示8折）
     */
    void updateOrderDiscount(@Param("id") Integer id, 
                             @Param("originalAmount") java.math.BigDecimal originalAmount, 
